        ...
        <div class="mx-auto max-w-full">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-8 m-auto md:pr-24 md:px-0 px-2 pt-5 md:pt-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 items-center">
                        ...
                        <div class="md:col-span-5">
                            <img :src="`/images/mockup-ebooks/${props.slugForm}.png`"
                                alt="The Ultimate Inspirations Design Book - Mockup - Covet House" class="m-auto">
                        </div>

                        <div class="md:col-span-7">
                            <h2 class="text-[16px] font-bold text-white md:mb-3 md:mt-0 mt-4">{{ props.titleForm }}</h2>
                ...
                <div
                    ...
                    <Link href="#">
                        <p class="text-[1.1rem] tracking-wider leading-5 font-bold text-white mb-4">COVET HOUSE <br>
                            <span class="text-[12px]">CATALOGUE</span>
                        </p>
                        <img src="/images/mockup-ebooks/catalogue-covet-house.png"
                            alt="The Most Powerful Tool to Inspire" class="mb-6">
